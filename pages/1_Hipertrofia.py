...
# --- SEGURIDAD Y LOGIN (iOS Friendly) ---
...
if not st.session_state["autenticado"]:
    ...
    with st.form("login_form_hipertrofia"):
        usuario = st.text_input("Usuario (Correo):", placeholder="g.basso.castillo@gmail.com")
        pwd = st.text_input("Contraseña de Comando:", type="password")
        submit = st.form_submit_button("Desbloquear Sistema")
